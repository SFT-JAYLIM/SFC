function DHparam = Set_BaseModel(Path, BaseModel)

pathfilename=[Path, '\Base_Model\', BaseModel,'.txt'];
...
for i = 1:in_data_size
    ...
    if in_data{i}(1) == '#'
        ...
        elseif key == "STL_Position"
            STL_Position(count) = str2double(in_data{i});
            count = count + 1;
...
DHparam.STL_Position = STL_Position;
end